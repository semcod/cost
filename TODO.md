...
**Generated on:** 2026-03-29T13:06:44.306065
**Total issues:** 46 active, 2 completed

---

## ✅ Completed Tasks

- [x] src/costs/reports/badge.py:81 - String concatenation can be converted to f-string
- [x] src/costs/reports/badge.py:79 - String concatenation can be converted to f-string
...
- [ ] src/costs/reports/badge.py:85 - String concatenation can be converted to f-string
- [ ] src/costs/reports/badge.py:83 - String concatenation can be converted to f-string
